...
class MSCOCOLabelledInputProducer(object):
    def __init__(self, config):
        self.path = config.path
        self.batch_size = config.batch_size
        self.tfrecords_filename = 'data_labelled.tfrecords'
    ...
    def inputs(self):
        ...
        images, category_batch = tf.train.shuffle_batch(
            [float_image, result.category],
